...
public class GraphicsWindow extends JFrame{
    ...
    private void init_components(){
        ...
        prm_series = new XYSeries("Prom celdas negras");
        prm_coll = new XYSeriesCollection();
        prm_coll.addSeries(prm_series);
        prom_graph = ChartFactory.createXYLineChart("Media","Generacion","Celdas",prm_coll,PlotOrientation.VERTICAL,true,false,false);
        prm_chart = new ChartPanel(prom_graph);
        prm_chart.setBounds(405, 0, 400, 300);
        add(prm_chart);
        
        var_series = new XYSeries("Vaianza celdas negras");
        var_coll = new XYSeriesCollection();
        var_coll.addSeries(var_series);
        var_graph = ChartFactory.createXYLineChart("Varianza","Generacion","Celdas^2",var_coll,PlotOrientation.VERTICAL,true,false,false);
